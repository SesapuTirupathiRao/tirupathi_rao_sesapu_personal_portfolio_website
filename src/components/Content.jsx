    ...
    <section id="content" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">YouTube & Blog</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Creating educational content to help thousands of students learn programming
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-900 border border-yellow-500/20 rounded-2xl shadow-lg p-8 hover:shadow-xl hover:shadow-yellow-500/10 transition-shadow duration-300">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">STR Telugu Channel</h3>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="text-center p-4 bg-gray-800 border border-yellow-500/20 rounded-xl">
                <div className="text-2xl font-bold text-yellow-400 mb-1">12K+</div>
          ...
          <div className="bg-gray-900 border border-yellow-500/20 rounded-2xl shadow-lg p-8 hover:shadow-xl hover:shadow-yellow-500/10 transition-shadow duration-300">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">STR EduTuts Blog</h3>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="text-center p-4 bg-gray-800 border border-yellow-500/20 rounded-xl">
                <div className="text-2xl font-bold text-yellow-400 mb-1">130+</div>
                <div className="text-sm text-gray-300">Blog Posts</div>
              </div>
              <div className="text-center p-4 bg-gray-800 border border-yellow-500/20 rounded-xl">
                <div className="text-2xl font-bold text-yellow-400 mb-1">100-200</div>
                <div className="text-sm text-gray-300">Daily Readers</div>
              </div>
            </div>
            
            <div className="mb-6">
              <h4 className="font-semibold text-white mb-3">Popular Topics:</h4>
              <div className="flex flex-wrap gap-2">
                {['Python Basics', 'Tkinter GUI', 'Django Web Dev', 'React Projects', 'DSA Solutions'].map((topic) => (
                  <span key={topic} className="px-3 py-1 bg-gray-800 border border-yellow-500/30 text-yellow-400 rounded-full text-sm">
                    {topic}
                  </span>
                ))}
              </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-gray-800 to-black border border-yellow-500/20 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-white mb-4">Making Learning Accessible</h3>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-6">
              I believe education should be accessible to everyone. Through my YouTube channel and blog, 
              I create content in Telugu to help students in my region learn programming and advance their careers.
            </p>
            <div className="flex justify-center space-x-8 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-yellow-400">Practical</div>
