...
const About = () => {
  const skills = [
    'Python', 'HTML', 'CSS', 'JavaScript', 'ReactJS', 'Django', 'MySQL', 'PHP', 'Tkinter'
  ];
  
  const tools = [
    'Canva', 'DaVinci Resolve', 'GitHub', 'VS Code'
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-black border border-yellow-500/20 p-6 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-yellow-500/10 transition-all duration-300">
            ...
            <div className="space-y-2 text-gray-300">
              <div>10th Grade (2014)</div>
              <div>Intermediate (2016)</div>
              <div>BTech Discontinued (2020)</div>
              <div className="text-yellow-400 font-semibold">BCA Started (2025)</div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-black border border-yellow-500/20 p-6 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-yellow-500/10 transition-all duration-300">
            ...
            <div className="flex flex-wrap gap-2">
              {skills.map((skill) => (
                <span key={skill} className="px-3 py-1 bg-gray-700 border border-yellow-500/30 text-yellow-400 rounded-full text-sm font-medium">
                  {skill}
                </span>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-black border border-yellow-500/20 p-6 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-yellow-500/10 transition-all duration-300">
            ...
            <div className="flex flex-wrap gap-2">
              {tools.map((tool) => (
                <span key={tool} className="px-3 py-1 bg-gray-700 border border-yellow-500/30 text-yellow-400 rounded-full text-sm font-medium">
                  {tool}
                </span>
              ))}
            </div>
